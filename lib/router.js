...
import '/imports/ui/pages/Profile_show/Profile_show.html';
...
// register a global helper to link from page to page
// (http://blazejs.org/api/templates.html#Template-registerHelper)
Template.registerHelper('pathFor', function(route, params, queryParams) {
...
FlowRouter.route('/profile/:username', {
    name: 'Profile.show',
    action: function() {
        BlazeLayout.render('App', { main: 'Profile_show' });
    },
});
